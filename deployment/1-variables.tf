...
variable "bastion_host_cidr" {
  ...
  type        = string
  default     = "0.0.0.0/32" #id address /32
}
...
variable "main_api_server_domain" {
  ...
  type        = string
  default     = "chatappserver.online"
}

variable "dev_api_server_domain" {
  description = "Dev API Server Domain"
  type        = string
  default     = "api.dev.chatappserver.online"
}

variable "ec2_iam_role_name" {
  description = "EC2 IAM Role Name"
  type        = string
  default     = "chatapp-server-ec2-role-pa1"
}

variable "ec2_iam_role_policy_name" {
  description = "EC2 IAM Role Policy Name"
  type        = string
  default     = "chatapp-server-ec2-role-policy-pa1"
}

variable "ec2_instance_profile_name" {
  description = "EC2 Instance Profile Name"
  type        = string
  default     = "chatapp-server-ec2-instance-profile-pa1"
}
...
variable "code_deploy_role_name" {
  ...
  type        = string
  default     = "chatapp-server-codedeploy-role-pa1"
}

variable "prefix" {
  description = "Prefix to be added to AWS resources tags"
  type        = string
  default     = "chatapp-server-pa1"
}
