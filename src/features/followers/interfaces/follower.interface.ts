...
export interface IFollowerDocument extends Document {
  ...
  followerId: mongoose.Types.ObjectId; // userids generated from the user model  -> following another user
  followeeId: mongoose.Types.ObjectId; // user who is being followed
  createdAt?: Date;
}
